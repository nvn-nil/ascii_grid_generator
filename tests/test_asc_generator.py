...
class TestAsciiGenerator(unittest.TestCase):
    def test_annual_power_map_generator(self):
        ...
        asc = AsciiGenerator(file_like=r"tests\data\WP-Gori-BlendedWind-WS100.asc")
        asc.generate_new_ascii_grid(r"tests\data\annual-energy-map.asc", -9999, single_run_function=build_annual_power_map)
